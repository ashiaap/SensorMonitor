...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    private TextView txSensorLight;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txSensorLight=(TextView)findViewById(R.id.sensor_light);
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        if(sensorType==Sensor.TYPE_PROXIMITY){
            txSensorProximity.setText("Proximity\n \n"+value);
        }if(sensorType==Sensor.TYPE_ACCELEROMETER){
            txSensorAccelero.setText("Accelerometer \n\n"+value);
        }if(sensorType==Sensor.TYPE_AMBIENT_TEMPERATURE){
            txSensorTemp.setText("Temperature \n\n"+value);
        }if(sensorType==Sensor.TYPE_RELATIVE_HUMIDITY){
            txSensorHum.setText("Humidity\n\n"+value);
        }if(sensorType==Sensor.TYPE_LIGHT){
            txSensorLight.setText("Light \n\n"+value);
        }if(sensorType==Sensor.TYPE_PRESSURE){
            txSensorPressure.setText("Pressure \n\n"+value);
        }
